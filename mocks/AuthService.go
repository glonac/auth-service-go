...
func (_m *AuthService) CreateAuth(ctx context.Context, _a1 auth.AuthRepoStruct) (auth.AuthRepoStruct, error) {
...
func (_m *AuthService) FetchAuth(ctx context.Context, id string, email string) (auth.AuthRepoStruct, error) {
